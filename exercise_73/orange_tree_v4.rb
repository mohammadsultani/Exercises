...
class OrangeTree
 attr_reader :age ,:height , :oranges
  ...
  def age!
    ...
    @age += 1
    @height += rand(80..120)
    @oranges << (1..rand(750..1200)).to_a if @age > 3
    @oranges.flatten!
  end 
...
orange = Orange.new(rand(3.0..5.0).ceil(1))
tree = OrangeTree.new(1, rand(8..12))
...
tree.age! until tree.any_oranges?
  ...
  until tree.dead?
    ...
    avg_diameter = ((basket.length * orange.diameter) / basket.length) # It's up to you to calculate the average diameter for this harvest.
